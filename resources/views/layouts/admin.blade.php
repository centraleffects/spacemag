...
<html lang="en">
  ...
  <body scroll-spy="" id="top" class=" theme-template-dark theme-pink alert-open alert-with-mat-grow-top-right">
          ...
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right navbar-right-no-collapse">
              <li class="dropdown pull-right">
                <button class="dropdown-toggle pointer btn btn-round-sm btn-link withoutripple" data-template-url="/tpl/partials/dropdown-navbar.html"> <i class="md md-more-vert f20"></i> </button>
              </li>
              <li class="dropdown pull-right">
                <button class="dropdown-toggle pointer btn btn-round-sm btn-link withoutripple" data-template-url="/tpl/partials/theme-picker.html"> <i class="md md-settings f20"></i> </button>
              </li>
            ...
            <div class="row no-gutter">
              <div class="col-sm-12 col-md-12 col-lg-9" style="background:#F9F9F9;">
                <div class="p-20 clearfix">
                  <div class="pull-right"> <a href="pages-material-bird.html" target="_blank" class="btn btn-round-sm btn-link" data-toggle="tooltip" title="Play material bird"><i class="md md-games"></i></a>
                ...
                <div class="p-20 no-p-t">
                  ...
                  <div class="row gutter-14">
                      ...
                      <div class="card">
                        ...
                        <div class="list-group">
                          <a href="#" class="list-group-item clearfix">
                            <div class="pull-left m-r-10"> <img class="img-responsive" src="/img/icons/ballicons/calculator.svg"> </div>
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <div class="pull-left m-r-10"> <img class="img-responsive" src="/img/icons/ballicons/server.svg"> </div>
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <div class="pull-left m-r-10"> <img class="img-responsive" src="/img/icons/ballicons/buzzer.svg"> </div>
                    ...
                    <div class="col-md-4">
                      <div class="panel panel-default left">
                        <div class="panel-heading">
                          <div class="pull-right">
                            <a href="#" class="btn btn-round-sm btn-link" data-template-url="/tpl/partials/dropdown-list-example.html"> <i class="md md-more-vert"></i> </a>
                          </div>
                    ...
                    <div class="col-md-3">
                      <div class="card">
                        <div class="card-image"> <img src="/img/photos/4.jpg" class="img-responsive" style="max-height:193px;">
                          <div class="card-title">Super card</div>
                        </div>
                        <div class="card-content">
                          <div class="card-profile pull-right"><img src="/img/icons/ballicons/bill.svg" alt="" style="width:75px;"></div>
                    ...
                    <div class="col-md-8">
                      <div class="card">
                        <div class="card-header">
                          <div class="actions"> <a href="#" class="btn btn-link btn-icon" data-template-url="/tpl/partials/dropdown-list-example.html"><i class="md md-more-vert"></i></a> </div>
              ...
              <div class="col-lg-3 col-md-12">
                <div class="p-20">
                  <div class="pull-right">
                    <ul class="list-unstyled">
                      <li class="dropdown">
                        <button type="button" class="btn btn-round-sm btn-link" aria-haspopup="true" aria-expanded="false" data-template-url="/tpl/partials/dropdown-list-example.html" data-toggle="tooltip" title="More stats"> <i class="md md-equalizer"></i> </button>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div role="tabpanel">
                    ...
                    <div class="tab-content m-t-10">
                      ...
                      <div role="tabpanel" class="tab-pane" id="tab-timeline">
                        <ul class="timeline">
                          <li>
                            <div class="timeline-badge"><img class="img-responsive" src="/img/icons/ballicons/demoltion.svg"></div>
                            <div class="timeline-panel">
                              <div class="timeline-heading">
                          ...
                          <li>
                            <div class="timeline-badge"><img class="img-responsive" src="/img/icons/ballicons/smart watch.svg"></div>
                            <div class="timeline-panel">
                              <div class="timeline-heading">
                          ...
                          <li>
                            <div class="timeline-badge"><img class="img-responsive" src="/img/icons/ballicons/conveyor.svg"></div>
                            <div class="timeline-panel">
                              <div class="timeline-heading">
                          ...
                          <li>
                            <div class="timeline-badge"><img class="img-responsive" src="/img/icons/ballicons/theatre.svg"></div>
                            <div class="timeline-panel">
                              <div class="timeline-heading">
    ...
    <script charset="utf-8" src="/js/vendors.min.js"></script>
    <script charset="utf-8" src="/js/app.min.js"></script>
  </body>
</html>