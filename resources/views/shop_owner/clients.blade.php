	...
	@slot('left')
		<div class="card hoverable" ng-controller="articlesController">
			<div class="row card-content">
			    ...
			    <div><a href="javascript:;;">Filter Result <a href="/shop/clients/new"><span class="badge">New Client</span></a></div>
    			<div>
					<ul class="collection">
        ...
        <div class="card hoverable">
            <div class="card-content">
              <span class="card-title">Coupons</span>
              	<div class="row">
			        <div class="input-field col s12">
			          <input id="textarea1" class="materialize-textarea" placeholder="Add a notes{{ empty($selectedClient->first_name) ? '' : ' to '.$selectedClient->first_name }}"></input>
			        </div>
			     </div>
              <div></div>
              <div></div>
