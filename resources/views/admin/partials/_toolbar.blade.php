		...
		<nav>
		    <div class="nav-wrapper">
		      <ul id="nav-mobile" class="left hide-on-med-and-down">
				 ...
				 <li><a href="#/categories" class="btn btn-flat waves-effect  waves-light">Categories</a></li>
				 <li><a href="#/transactions" class="btn btn-flat waves-effect  waves-light">Transactions</a></li>
		      </ul>
		    </div>
		</nav>
	</div>
