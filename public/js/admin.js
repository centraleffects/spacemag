...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery) {window.app = angular.module('rebuy', []);

(function (admin) {
	admin(__webpack_provided_window_dot_jQuery, window, document);
	...
	$(function () {
		$.adminJS = {
			...
			loadsubpage: function loadsubpage(page) {
